...
public class Project01Recap {
    public static void main(String[] args) {
        ...
        String myFaveSong = "Turn the page";
        String myFaveActivity = "Gaming";

        System.out.println("My favorite movie is " + myFavMovie);
        System.out.println("My favorite city is " + myFavCity);
        System.out.println("My favorite song is " + myFaveSong);
        System.out.println("My favorite activity is " + myFaveActivity);
        ...
        int myFavNumber = 420;
        int numberOfStatesVisited = 50;
        int numberOfCountriesVisited = 16;

        System.out.println("My favorite number is " + myFavNumber);
        System.out.println("The number of states visited is " + numberOfStatesVisited);
        System.out.println("The number of countries are visited is " + numberOfCountriesVisited);
