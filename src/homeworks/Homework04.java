...
public class Homework04 {
    public static void main(String[] args) {
         ...
         */
        // invoke existing method from ScannerHelper
        String name = ScannerHelper.getAName();
        // Print the length
        System.out.println("The length of the name is = " + name.length());
        // Find and print the first character in the name
         ...
         */
        // invoke existing method from ScannerHelper
        String fullAddress = ScannerHelper.getAnAddress();
        // Check if city is Chicago, Des Plaines or other city (ignore cases) in the address
        if (fullAddress.toLowerCase().contains("Chicago")) {
            System.out.println("You are in the club");
        } else if (fullAddress.contains("Des Plaines")) {
        ...
        Expected Output 4:
            Red is in the list
        */
       // create method that asks user to enter their fav color, then invoke it
...
//        // find and print the second word
//        System.out.println("The second word is = " + str.trim().substring(5,7).toLowerCase());
//        // find and print the third word
//        System.out.println("The third word is = " + str.trim().substring(str.trim().length()- 3).toLowerCase());
