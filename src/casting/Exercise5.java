...
public class Exercise5 {
    public static void main(String[] args) {
         ...
         */
        System.out.println("Product of " + i1 + " and" + i2 + " = " + i1 * i2 );
        System.out.println("Sum of  s1 and s2 = " + (i1 + i2)); //45
        System.out.println("Difference of  s1 and s2 = " + (i1 - i2)); // 25
        System.out.println("Difference of  s1 and s2 = " + Math.abs(i1 - i2)); // 25
        ...
        System.out.println("Max number of  s1 and s2 = " + Math.max(i1, i2)); // 10
        System.out.println("Min number of  s1 and s2 = " + Math.min(i1, i2)); // 35
